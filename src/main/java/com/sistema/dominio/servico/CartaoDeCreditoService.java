...
public class CartaoDeCreditoService {
    ...
    public CartaoDeCredito criarCartao(String bandeira, String nomeTitular, LocalDate dataValidade, String cvv, BigDecimal limiteTotal, BigDecimal limiteDisponivel, Cliente cliente) {
        String numero = geradorNumeroCartao.gerarNumero();
        return new CartaoDeCredito(numero, bandeira, nomeTitular, dataValidade, cvv, limiteTotal, limiteDisponivel, cliente);
    }
}
